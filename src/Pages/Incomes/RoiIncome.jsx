...
const RoiIncome = () => {
    ...
    function FetchData() {
        setLoading(true);
        let myPath = `${ApiPaths.Incomes}/?type=roi`
        axios({
            method: "get",
            url: myPath,
            headers: {
    ...
    function FetchDataFilter() {
        setLoading(true);
        let myPath = `${ApiPaths.Incomes}/?type=roi&username=${userId}&start_date=${fromDate}&end_date=${toDate}`
        axios({
            method: "get",
            url: myPath,
            headers: {
                        ...
                        <Col>
                            <div class="lastestTransaction_table">
                                <div class="tableTrans">
                                    <div className="incomesTitle lastest">ROI Incomes</div>
                                    <table class="mt-2">
                                        <thead>
                                            <tr>
                                                <th>S.NO</th>
