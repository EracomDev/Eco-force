...
const SignupLevelIncome = () => {
    ...
    function FetchData() {
        setLoading(true);
        let myPath = `${ApiPaths.Incomes}/?type=signup_level`
        axios({
            method: "get",
            url: myPath,
            headers: {
    ...
    function FetchDataFilter() {
        setLoading(true);
        let myPath = `${ApiPaths.Incomes}/?type=signup_level&username=${userId}&start_date=${fromDate}&end_date=${toDate}`
        axios({
            method: "get",
            url: myPath,
            headers: {
                        ...
                        <Col>
                            <div class="lastestTransaction_table">
                                <div class="tableTrans">
                                    <div className="incomesTitle lastest">Signup Level Incomes</div>
                                    <table class="mt-2">
                                        <thead>
                                            <tr>
                                                <th>S.NO</th>
...
export default SignupLevelIncome