...
const RoiLevelIncome = () => {
    ...
    function FetchData() {
        setLoading(true);
        let myPath = `${ApiPaths.Incomes}/?type=roi_level`
        axios({
            method: "get",
            url: myPath,
            headers: {
    ...
    function FetchDataFilter() {
        setLoading(true);
        let myPath = `${ApiPaths.Incomes}/?type=roi_level&username=${userId}&start_date=${fromDate}&end_date=${toDate}`
        axios({
            method: "get",
            url: myPath,
            headers: {
                        ...
                        <Col>
                            <div class="lastestTransaction_table">
                                <div class="tableTrans">
                                    <div className="incomesTitle lastest">Roi Level Incomes</div>
                                    <table class="mt-2">
                                        <thead>
                                            <tr>
                                                <th>S.NO</th>
